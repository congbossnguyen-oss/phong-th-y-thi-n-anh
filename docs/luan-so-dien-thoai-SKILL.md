...
**Bắt buộc áp dụng mục 4b (hiệu ứng số 5 và số 0)** — với mỗi vị trí có số 5 hoặc số 0 trong dãy, xác định nó đứng trước/giữa/sau cặp gốc nào, rồi nêu đúng hiệu ứng tương ứng (giữ nguyên / đột hiển / khuếch đại x2 / ẩn ngầm / mất hẳn) — đặc biệt cảnh báo mạnh khi số 5 hoặc số 0 làm khuếch đại một hung tinh.
