...
description: Dùng skill này khi Công muốn luận 1 lá số Bát Tự theo trường phái Manh Phái (không phải Tử Bình truyền thống) — kích hoạt khi Công nói rõ "luận theo Manh Phái", "xem theo Manh phái", hoặc hỏi về "Thể Dụng", "Khách Chủ", "Tố Công", "Đảng Thế", "Chính cục Phản cục", "Công thần Tặc thần", "cấu trúc chế dụng/hóa dụng/hợp dụng", hoặc hỏi lá số này "tạo công" thế nào, có phải "đại nhân vật" không. Nếu Công chỉ nói chung chung "luận giúp tôi lá số này" không chỉ định trường phái, hỏi Công muốn luận theo Tử Bình (dùng skill `luan-giai-bat-tu`) hay Manh Phái (skill này) trước khi bắt đầu — 2 trường phái dùng khung phân tích khác nhau, không trộn lẫn tùy tiện trong cùng 1 lượt luận. Skill chứa phương pháp riêng (Thể-Dụng, Khách-Chủ, Tố Công, Đảng-Thế, Chính Cục/Phản Cục, Công Thần/Tặc Thần, 5 cấu trúc tố công, Hiệu suất tố công) đúc kết từ tài liệu "Manh Phái Sơ Cấp", không có sẵn trong kiến thức nền của Claude.
---
...
Cần: ngày giờ sinh đầy đủ (hoặc lá số đã lập sẵn) + giới tính + câu hỏi cụ thể (tài vận/quan vận/hôn nhân/sức khỏe/đánh giá tổng thể "tầng" của mệnh cục). Thiếu thì hỏi lại, không tự bịa.

## Bước 1 — Lập Tứ Trụ, xác định Nhật Chủ

Dùng `luan-giai-bat-tu/references/lap-tu-tru.md`.
...
Đọc `references/cau-truc-to-cong.md` và `references/chinh-cuc-phan-cuc.md`.
...
Đọc `references/cau-truc-to-cong.md` mục 7. Dùng bảng Hiệu Suất Hợp Chế hoặc Hiệu Suất Hình Xung Xuyên Chế tùy cơ chế Tố Công đang dùng, để đánh giá MỨC ĐỘ (không chỉ có/không) của Danh và Tài.

## Bước 8 — Luận Đại Vận & Lưu Niên
...
- Tóm tắt: Thể vượng/nhược, Tố Công chính, cấu trúc (1 trong 5 loại), Chính/Phản Cục, Hiệu Suất Tố Công, giai đoạn Đại Vận thuận/nghịch.
