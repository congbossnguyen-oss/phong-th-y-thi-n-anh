...
export const subscriptionTierEnum = pgEnum("subscription_tier", ["co_ban", "cao_cap", "vip"]);
...
// ra" vẫn tìm lại được, nhưng có giới hạn, không tồn dữ liệu vô thời hạn). Dọn bản ghi quá hạn ở
// cron dọn dẹp hằng ngày có sẵn (xem wrangler.jsonc `schedule: "0 2 * * *"`), KHÔNG lưu vĩnh viễn.
