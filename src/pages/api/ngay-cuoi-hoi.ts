...
import { calculateCuoiHoiRange } from "@thien-anh/trachnhat-engine";
...
export const GET: APIRoute = async ({ url }) => {
  ...
  // Chặn khoảng ngày đảo ngược hoặc quá dài — engine tự cắt 120 ngày, nhưng báo sớm cho gọn.
  ...
  try {
    const result = calculateCuoiHoiRange({
      namSinhCoDau,
      namSinhChuRe,
      startDate: start,
      endDate: end,
