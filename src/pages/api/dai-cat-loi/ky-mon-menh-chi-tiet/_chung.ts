 ...
 */
export const TOOL_SLUG = "ky-mon-menh-chi-tiet";

export function jsonResponse(body: unknown, status: number): Response {
  return new Response(JSON.stringify(body), { status, headers: { "Content-Type": "application/json" } });
}

/** Đầu vào = đúng ngày-giờ SINH đã dùng để lập lá bàn Mệnh miễn phí trên /lap-ky-mon (không hỏi
 * lại khách) — khớp shape LapLaBanInputLich (trừ cheDo, luôn cố định "menh" ở nơi gọi). */
