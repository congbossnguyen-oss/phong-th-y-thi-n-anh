...
// ⚠️ Endpoint thử nghiệm nội bộ, KHÔNG thu phí — dùng khi TEST_MODE ở trang. Không bắt đăng nhập.
export const POST: APIRoute = async ({ request, clientAddress }) => {
  const limited = checkRateLimit({ request, clientAddress }, { key: "testcalc-khai-truong-cc", max: 15, windowMs: 60_000 });
