...
/**
 * Tạo đơn cho module Ngày Giờ Nhận Chức (499.000đ).
 *
...
export const POST: APIRoute = async ({ request, locals, clientAddress }) => {
  const limited = checkRateLimit({ request, clientAddress }, { key: "checkout-nhan-chuc", max: 10, windowMs: 60_000 });
  ...
  try {
    ...
    console.error("[nhan-chuc/checkout] Lỗi không mong đợi khi tạo đơn hàng:", err);
    return jsonResponse(
