// Bản ĐỘC LẬP cho app Quân Sư của "Ngày ký hợp đồng" — xem ghi chú đầu file
...
export const GET: APIRoute = async ({ url, request, clientAddress }) => {
  ...
  const limited = checkRateLimit({ request, clientAddress }, { key: "free-qs-ky-hop-dong", max: 20, windowMs: 60_000 });
