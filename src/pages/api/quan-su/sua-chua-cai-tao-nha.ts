// API riêng cho app Quân Sư — bản độc lập của /api/sua-chua-cai-tao-nha (tách khỏi web 1/9/2026,
// xem project_quan_su_tach_doc_lap_khoi_web.md). Chỉ dùng chung engine tính toán, không dùng chung route.
...
export const GET: APIRoute = async ({ url, request, clientAddress }) => {
  ...
  const limited = checkRateLimit({ request, clientAddress }, { key: "free-qs-sua-chua", max: 20, windowMs: 60_000 });
