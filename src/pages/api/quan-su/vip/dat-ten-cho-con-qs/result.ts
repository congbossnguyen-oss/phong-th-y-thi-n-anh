 ...
 * Poll 3 giây/lần từ trang kết quả cho tới khi đơn `confirmed`.
 */
export const GET: APIRoute = async ({ url, request, clientAddress }) => {
  const limited = checkRateLimit({ request, clientAddress }, { key: "result-dat-ten-qs", max: 60, windowMs: 60_000 });
