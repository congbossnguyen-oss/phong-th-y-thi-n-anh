 ...
 *
 * ⚠️ CỐ Ý không kiểm tra chính chủ: module này không bắt đăng nhập, orderCode là "vé" ngẫu nhiên.
 */
export const GET: APIRoute = async ({ url, request, clientAddress }) => {
  const limited = checkRateLimit({ request, clientAddress }, { key: "result-ky-hd-qs", max: 60, windowMs: 60_000 });
