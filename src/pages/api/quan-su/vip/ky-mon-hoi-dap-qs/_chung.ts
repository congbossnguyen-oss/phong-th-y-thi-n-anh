 ...
 * của src/pages/api/dai-cat-loi/ky-mon-hoi-dap/_chung.ts — toolSlug đổi hậu tố "-qs" để tách bạch
 * đơn hàng web/app, logic luận giải dùng chung qua src/lib/kymon/*.
 */
import { traTinhHuong, laQuanHeCauHoi, type QuanHeCauHoi } from "../../../../../lib/kymon/danhMucCauHoi";

export const TOOL_SLUG = "ky-mon-hoi-dap-qs";
