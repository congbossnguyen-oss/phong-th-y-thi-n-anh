...
const TOOL_SLUG = "hop-hon-qs";

/**
 * Tra trạng thái đơn Hợp Hôn (app Quân Sư) — CHỈ trả trạng thái, không trả nội dung luận giải.
 *
 * Trang `/quan-su/hop-hon?orderCode=...` tự dựng kết quả phía máy chủ, endpoint này chỉ phục vụ
