// Bản ĐỘC LẬP cho app Quân Sư của "Đẩu Thủ Chọn Ngày" (anh Công chốt 1/9/2026: Quân Sư không đấu
// nối code với web nữa). CỐ Ý gần như y hệt `src/pages/api/dai-cat-loi/dau-thu-chon-ngay/checkout.ts`
// — chấp nhận trùng lặp thay vì import chéo sang namespace `dai-cat-loi`. Thêm 4/9/2026 (bỏ sót
// lúc mở bán bản web 1/9 — khiến khách bấm vào module này trong app bị văng về trang chủ).
...
const TOOL_SLUG = "dau-thu-chon-ngay-qs";
...
export const POST: APIRoute = async ({ request, locals, clientAddress }) => {
  const limited = checkRateLimit({ request, clientAddress }, { key: "checkout-dau-thu-qs", max: 10, windowMs: 60_000 });
