// Bản ĐỘC LẬP cho app Quân Sư — xem ghi chú đầu file `checkout.ts` cùng thư mục. Endpoint xuất PDF
// dùng chung hàm `taoHoSoTangLe` với bản web — không có toolSlug riêng vì không đọc/ghi đơn hàng.
