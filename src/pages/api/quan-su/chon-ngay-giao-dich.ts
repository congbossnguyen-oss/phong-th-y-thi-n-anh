// Bản ĐỘC LẬP cho app Quân Sư của "Chọn Ngày Giao Dịch / Nhận Tài Sản" — xem ghi chú đầu file
...
export const GET: APIRoute = async ({ url, request, clientAddress }) => {
  ...
  const limited = checkRateLimit({ request, clientAddress }, { key: "free-qs-giao-dich", max: 20, windowMs: 60_000 });
