// Bản ĐỘC LẬP cho app Quân Sư của "Ngày Giờ Khai Quang – An Vị Vật Phẩm" — xem ghi chú đầu file
...
export const GET: APIRoute = async ({ url, request, clientAddress }) => {
  ...
  const limited = checkRateLimit({ request, clientAddress }, { key: "free-qs-khai-quang", max: 20, windowMs: 60_000 });
