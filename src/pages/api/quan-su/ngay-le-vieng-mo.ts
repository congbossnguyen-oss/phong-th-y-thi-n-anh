// API riêng cho app Quân Sư — bản độc lập của /api/ngay-le-vieng-mo (tách khỏi web 1/9/2026, xem
...
export const GET: APIRoute = async ({ url, request, clientAddress }) => {
  ...
  const limited = checkRateLimit({ request, clientAddress }, { key: "free-qs-vieng-mo", max: 20, windowMs: 60_000 });
