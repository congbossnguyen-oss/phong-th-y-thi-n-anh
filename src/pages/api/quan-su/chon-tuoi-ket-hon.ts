// Bản ĐỘC LẬP cho app Quân Sư của "Chọn Tuổi Kết Hôn" — xem ghi chú đầu file `chon-nam-sinh-con.ts`
// cùng thư mục. Module miễn phí, không có toolSlug/thanh toán.
...
export const GET: APIRoute = async ({ url, request, clientAddress }) => {
  ...
  try {
    if (mode === "tim-hop") {
      ...
      const limited = checkRateLimit({ request, clientAddress }, { key: "free-qs-chon-tuoi", max: 20, windowMs: 60_000 });
