// API riêng cho app Quân Sư — bản độc lập của /api/xem-tuoi-xong-dat (tách khỏi web 1/9/2026, xem
...
export const GET: APIRoute = async ({ url, request, clientAddress }) => {
  ...
  const limited = checkRateLimit({ request, clientAddress }, { key: "free-qs-xem-tuoi-xong-dat", max: 20, windowMs: 60_000 });
