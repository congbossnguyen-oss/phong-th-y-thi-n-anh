// Bản ĐỘC LẬP cho app Quân Sư của "Giờ tốt trong ngày" — xem ghi chú đầu file
// `chon-nam-sinh-con.ts` cùng thư mục. Module miễn phí, không có toolSlug/thanh toán. Được các
// module app khác (Ký Hợp Đồng, Khai Trương, Chọn Ngày Giao Dịch...) gọi tới khi tách bản của họ.
