...
// xem project_quan_su_tach_doc_lap_khoi_web.md). Bản độc lập của /api/giao-te-tiec-tung.
...
export const GET: APIRoute = async ({ url, request, clientAddress }) => {
  ...
  const limited = checkRateLimit({ request, clientAddress }, { key: "free-qs-giao-te", max: 20, windowMs: 60_000 });
