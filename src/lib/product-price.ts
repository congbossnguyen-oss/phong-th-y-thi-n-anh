// Cách hiển thị GIÁ VẬT PHẨM ra ngoài trang — nguồn duy nhất cho mọi nơi hiển thị giá, để các trang
// (danh sách vật phẩm, trang chi tiết, khối Gương Bát Quái) không bao giờ hiện khác nhau.
//
