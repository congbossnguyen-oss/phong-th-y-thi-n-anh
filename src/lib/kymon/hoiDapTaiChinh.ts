...
// phần "chi tiết kỹ thuật" để tham khảo thêm, không chặn/đổi kết luận chính.
...
function luanTaiVanChung(laBan: LapLaBanResult): KetQuaHoiDapTaiChinh {
  ...
  if (laKV(sinhMon)) {
    return ketQua(
      ...
      "Sinh Môn (dụng thần Tài) Không Vong.",
    );
  }
  ...
  if (qh === "sinh") {
    return ketQua(
      ...
      `Sinh Môn tại ${sinhMon.huong} sinh cho cung Can Ngày tại ${canNgay.huong}.`,
    );
  }
  if (qh === "khac") {
    return ketQua(
      ...
      `Sinh Môn tại ${sinhMon.huong} bị cung Can Ngày (${canNgay.huong}) khắc.`,
    );
  }
  if (qh === "duocSinh") {
    return ketQua(
      ...
      `Cung Can Ngày (${canNgay.huong}) sinh cho Sinh Môn tại ${sinhMon.huong}.`,
    );
  }
  if (qh === "bịKhac") {
    return ketQua(
      ...
      `Cung Can Ngày (${canNgay.huong}) bị Sinh Môn tại ${sinhMon.huong} khắc chế ngược.`,
    );
  }
  return ketQua(
    "can_luu_y",
    "Tài vận ở mức bình thường, không có dấu hiệu đột biến rõ rệt — cứ theo kế hoạch đã định, không cần vội vàng.",
    `Sinh Môn (${sinhMon.huong}) và cung Can Ngày (${canNgay.huong}) cùng hành/tỉ hòa.`,
  );
}
...
function luanVayTien(laBan: LapLaBanResult): KetQuaHoiDapTaiChinh {
  ...
  if (laKV(tp) || laKV(ts)) {
    return ketQua(
      ...
      "Trực Phù hoặc Trực Sử Không Vong (a4-vay-va-cho-muon-tien.md, mục I).",
    );
  }
  ...
  if (qh === "sinh" || qh === "bịKhac" /* Trực Sử khắc Trực Phù */) {
    return ketQua(
      ...
      `Trực Phù (${tp.huong}) sinh Trực Sử (${ts.huong}), hoặc Trực Sử khắc Trực Phù — đều là dấu hiệu vay được (a4-vay-va-cho-muon-tien.md, mục I).`,
    );
  }
  if (qh === "khac" || qh === "duocSinh" /* Trực Sử sinh Trực Phù */) {
    return ketQua(
      ...
      `Trực Phù (${tp.huong}) khắc Trực Sử (${ts.huong}), hoặc Trực Sử sinh Trực Phù — đều là dấu hiệu không vay được (a4-vay-va-cho-muon-tien.md, mục I).`,
    );
  }
  ...
  return ketQua(
    ...
    `Trực Phù (${tp.huong}) và Trực Sử (${ts.huong}) tỉ hòa — nguồn không có quy tắc trực tiếp cho trường hợp này.`,
  );
}
...
function luanChoVay(laBan: LapLaBanResult): KetQuaHoiDapTaiChinh {
  ...
  if (qhTa === "sinh" && qhSm === "sinh") {
    return ketQua(
      ...
      "Sinh Môn và Thiên Ất đều sinh cho Trực Phù (a4-vay-va-cho-muon-tien.md, mục II).",
    );
  }
  ...
  if (qhTa === "khac" && qhSm === "khac") {
    return ketQua(
      ...
      "Sinh Môn và Thiên Ất đều khắc Trực Phù (a4-vay-va-cho-muon-tien.md, mục II).",
    );
  }
  ...
  if (motSinhMotKhac) {
    return ketQua(
      ...
      "Sinh Môn và Thiên Ất, một sinh một khắc Trực Phù (a4-vay-va-cho-muon-tien.md, mục II).",
    );
  }
  ...
  if (qhTa === "bịKhac") {
    return ketQua(
      ...
      "Trực Phù khắc được Thiên Ất — mình khắc chế được con nợ (a4-vay-va-cho-muon-tien.md, mục II).",
    );
  }
  ...
  if (qhTa === "duocSinh") {
    return ketQua(
      ...
      "Trực Phù sinh Thiên Ất (a4-vay-va-cho-muon-tien.md, mục II).",
    );
  }
  return ketQua(
    "can_luu_y",
    ...
    "Tổ hợp Sinh Môn/Thiên Ất/Trực Phù chưa rơi vào nhóm quy tắc rõ ràng (a4-vay-va-cho-muon-tien.md, mục II).",
  );
}
...
function luanDoiNo(laBan: LapLaBanResult): KetQuaHoiDapTaiChinh {
  ...
  if (qhTmTa === "bịKhac") {
    return ketQua(
      ...
      "Thiên Ất khắc Thương Môn — người đi đòi không giải quyết được (a4-vay-va-cho-muon-tien.md, mục III).",
    );
  }
  ...
  if (qhTmTa === "khac") {
    if (qhTmTp === "sinh" && qhTaTp === "sinh") {
      return ketQua(
        ...
        "Thương Môn khắc Thiên Ất (người đòi thực tâm), đồng thời Thương Môn và Thiên Ất đều sinh Trực Phù (a4-vay-va-cho-muon-tien.md, mục III).",
      );
    }
    return ketQua(
      "can_luu_y",
      ...
      "Thương Môn khắc Thiên Ất (đòi thực tâm) nhưng quan hệ với Trực Phù chưa đồng thuận hoàn toàn (a4-vay-va-cho-muon-tien.md, mục III).",
    );
  }
  ...
  if (qhTmTp === "khac" && qhTaTp === "khac") {
    return ketQua(
      ...
      "Thương Môn và Thiên Ất đều khắc Trực Phù (a4-vay-va-cho-muon-tien.md, mục III).",
    );
  }
  ...
  if (qhTmTp === "sinh" && qhTaTp === "sinh") {
    return ketQua(
      ...
      "Thương Môn và Thiên Ất đều sinh cho Trực Phù (a4-vay-va-cho-muon-tien.md, mục III).",
    );
  }
  return ketQua(
    "can_luu_y",
    ...
    "Tổ hợp Thương Môn/Thiên Ất/Trực Phù chưa rơi vào nhóm rõ ràng cát/hung (a4-vay-va-cho-muon-tien.md, mục III).",
  );
}
...
function luanGiaoDichMuaBan(laBan: LapLaBanResult): KetQuaHoiDapTaiChinh {
  ...
  if (laKV(cn) || laKV(cg)) {
    return ketQua(
      ...
      "Can Ngày hoặc Can Giờ Không Vong (a5-cau-tai-hop-tac-kinh-doanh.md, mục I).",
    );
  }
  ...
  if (qh === "sinh") {
    ketLuan = ketQua("can_luu_y", "Giao dịch có lợi hơn cho bên bán — nếu bạn là người mua, cân nhắc thương lượng thêm về giá.", "Can Ngày (người mua) sinh Can Giờ (người bán).");
  } else if (qh === "duocSinh") {
    ketLuan = ketQua("thuan_loi", "Giao dịch có lợi hơn cho bên mua — nếu bạn là người mua, đây là thời điểm khá tốt để chốt giao dịch.", "Can Giờ (người bán) sinh Can Ngày (người mua).");
  } else if (qh === "khac") {
    ketLuan = ketQua("khong_thuan", "Nếu bạn là người mua, tình huống này cho thấy không thực sự cần mua lúc này — cân nhắc lại có nên tiếp tục hay không.", "Can Ngày (người mua) khắc Can Giờ (người bán).");
  } else if (qh === "bịKhac") {
    ketLuan = ketQua("khong_thuan", "Nếu bạn là người bán, tình huống này cho thấy không thực sự cần bán lúc này — cân nhắc lại có nên tiếp tục hay không.", "Can Giờ (người bán) khắc Can Ngày (người mua).");
  } else {
    ketLuan = ketQua("thuan_loi", "Giao dịch diễn ra công bằng, hai bên ngang sức ngang tài, không ai chịu thiệt rõ rệt.", "Can Ngày và Can Giờ tỉ hòa (a5-cau-tai-hop-tac-kinh-doanh.md, mục I).");
  }
...
function luanDauTu(laBan: LapLaBanResult): KetQuaHoiDapTaiChinh {
  ...
  if (laNhapMo(sm)) {
    return ketQua(
      ...
      "Sinh Môn Nhập Mộ (a5-cau-tai-hop-tac-kinh-doanh.md, mục II).",
    );
  }
  ...
  if (qh === "sinh") {
    return ketQua("thuan_loi", "Đầu tư khoản này có triển vọng sinh lời tốt, khả năng thu về lợi nhuận đáng kể (có thể gấp đôi vốn bỏ ra).", "Sinh Môn sinh cho Giáp Tý (vốn) (a5-cau-tai-hop-tac-kinh-doanh.md, mục II).");
  }
  if (qh === "hoa") {
    return ketQua("can_luu_y", "Đầu tư khoản này có lời nhưng ở mức vừa phải, không đột biến — nên giữ kỳ vọng thực tế.", "Sinh Môn và Giáp Tý (vốn) tỉ hòa (a5-cau-tai-hop-tac-kinh-doanh.md, mục II).");
  }
  // "Giáp Tý (M) mà khắc cho Sinh môn thì phải tăng vốn mới có lời" (Vốn khắc Sinh Môn = B khắc A = qh "bịKhac").
  if (qh === "bịKhac") {
    return ketQua("can_luu_y", "Với số vốn hiện tại khó có lời — nếu muốn tiếp tục, cần tăng thêm vốn mới có khả năng sinh lời.", "Giáp Tý (vốn) khắc Sinh Môn — phải tăng vốn mới có lời (a5-cau-tai-hop-tac-kinh-doanh.md, mục II).");
  }
  ...
  return ketQua(
    ...
    "Sinh Môn khắc cho Giáp Tý (vốn) (a5-cau-tai-hop-tac-kinh-doanh.md, mục II).",
  );
}
...
function luanMuaHang(laBan: LapLaBanResult): KetQuaHoiDapTaiChinh {
  ...
  if (laKV(cg) || laNhapMo(cg)) {
    return ketQua(
      ...
      "Can Giờ (hàng hóa) Không Vong hoặc Nhập Mộ (a5-cau-tai-hop-tac-kinh-doanh.md, mục III).",
    );
  }
  ...
  if (qh === "sinh") {
    return ketQua("thuan_loi", `Mua hàng lần này có lời, bất luận chất lượng hàng tốt hay chưa thật hoàn hảo.${canhBao}`, "Can Giờ (hàng hóa) sinh Can Ngày (người mua) — bất luận hàng tốt xấu vẫn có lời (a5-cau-tai-hop-tac-kinh-doanh.md, mục III).");
  }
  // "Can ngày khắc Can giờ thì mua có lời" (Can Ngày khắc Can Giờ = B khắc A = qh "bịKhac").
  if (qh === "bịKhac") {
    return ketQua("thuan_loi", `Mua hàng lần này có lời.${canhBao}`, "Can Ngày khắc Can Giờ — mua có lời (a5-cau-tai-hop-tac-kinh-doanh.md, mục III).");
  }
  // "Can ngày sinh Can giờ thì chủ động mua nhưng không có lời" (Can Ngày sinh Can Giờ = B sinh A = qh "duocSinh").
  if (qh === "duocSinh") {
    return ketQua("can_luu_y", `Bạn khá ưng/thích món hàng này nên chủ động mua, nhưng khó có lời — mua vì thích chứ không phải để kinh doanh có lãi.${canhBao}`, "Can Ngày sinh Can Giờ — chủ động mua nhưng không có lời (a5-cau-tai-hop-tac-kinh-doanh.md, mục III).");
  }
  // "Can giờ mà khắc Can ngày... thì không có lời mà còn lỗ vốn" (Can Giờ khắc Can Ngày = A khắc B = qh "khac").
  return ketQua("khong_thuan", `Mua hàng lần này không có lời, cần cẩn trọng nguy cơ lỗ vốn.${canhBao}`, "Can Giờ khắc Can Ngày — không có lời mà còn lỗ vốn (a5-cau-tai-hop-tac-kinh-doanh.md, mục III).");
}
...
function luanBanHang(laBan: LapLaBanResult): KetQuaHoiDapTaiChinh {
  ...
  if (coLoiTuCg) {
    return ketQua("thuan_loi", `Bán hàng lần này có lời. ${dongToc}`, "Can Giờ (hàng hóa) sinh cho Giáp Tý (vốn) hoặc Sinh Môn (a5-cau-tai-hop-tac-kinh-doanh.md, mục IV).");
  }
  return ketQua(
    "can_luu_y",
    `Bán hàng lần này khó có lời, nhưng vẫn giữ được vốn — không xem đây là thất bại. ${dongToc}`,
    "Can Giờ (hàng hóa) không sinh cho Giáp Tý (vốn) hay Sinh Môn, hoặc khắc nhau — không lời nhưng bảo toàn vốn là tốt (a5-cau-tai-hop-tac-kinh-doanh.md, mục IV).",
  );
}
...
function luanMoCuaHang(laBan: LapLaBanResult): KetQuaHoiDapTaiChinh {
  ...
  if (laKV(km) || laNhapMo(km)) {
    return ketQua(
      ...
      "Khai Môn Không Vong hoặc Nhập Mộ (a5-cau-tai-hop-tac-kinh-doanh.md, mục V).",
    );
  }

  const qh = quanHeCung(km.soCung, cn.soCung); // Khai Môn → Can Ngày
  if (qh === "sinh") {
    return ketQua("thuan_loi", "Mở cửa hàng/công ty vào lúc này khá thuận lợi, có tiềm năng kinh doanh phát đạt.", "Khai Môn sinh cho cung Can Ngày (a5-cau-tai-hop-tac-kinh-doanh.md, mục V).");
  }
  if (qh === "hoa") {
    return ketQua("thuan_loi", "Mở cửa hàng/công ty vào lúc này có lợi, hai bên (bạn và việc kinh doanh) cùng thuận.", "Khai Môn và cung Can Ngày tỉ hòa (a5-cau-tai-hop-tac-kinh-doanh.md, mục V).");
  }
  return ketQua(
    "khong_thuan",
    ...
    "Khai Môn khắc cung Can Ngày, hoặc quan hệ không thuận (a5-cau-tai-hop-tac-kinh-doanh.md, mục V).",
  );
}
...
function luanHopTacLamAn(laBan: LapLaBanResult): KetQuaHoiDapTaiChinh {
  ...
  let ketLuan: KetQuaHoiDapTaiChinh;
  if (qh === "sinh") {
    ketLuan = ketQua("thuan_loi", "Hợp tác lần này có lợi cho bạn nhiều hơn.", "Can Giờ (đối tác) sinh cho Can Ngày (mình) (a5-cau-tai-hop-tac-kinh-doanh.md, mục VI).");
  } else if (qh === "duocSinh" /* Can Ngày sinh Can Giờ */) {
    ketLuan = ketQua("can_luu_y", "Hợp tác lần này có lợi cho đối tác nhiều hơn bạn.", "Can Ngày sinh cho Can Giờ (đối tác) (a5-cau-tai-hop-tac-kinh-doanh.md, mục VI).");
  } else if (qh === "hoa") {
    ketLuan = ketQua("thuan_loi", "Hợp tác lần này công bằng, hai bên đều có lợi ngang nhau.", "Can Ngày và Can Giờ tỉ hòa (a5-cau-tai-hop-tac-kinh-doanh.md, mục VI).");
  } else if (qh === "khac" /* Can Giờ khắc Can Ngày */) {
    ketLuan = ketQua("khong_thuan", "Hợp tác lần này bất lợi cho bạn — nên cân nhắc kỹ điều khoản trước khi ký kết, tránh phần thiệt nghiêng về phía mình.", "Can Giờ (đối tác) khắc Can Ngày (mình) (a5-cau-tai-hop-tac-kinh-doanh.md, mục VI).");
  } else {
    ketLuan = ketQua("can_luu_y", "Hợp tác lần này bất lợi cho đối tác — nên chia sẻ công bằng hơn nếu muốn hợp tác lâu dài, tránh để đối tác chịu thiệt quá nhiều.", "Can Ngày (mình) khắc Can Giờ (đối tác) (a5-cau-tai-hop-tac-kinh-doanh.md, mục VI).");
  }
