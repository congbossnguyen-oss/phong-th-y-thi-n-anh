...
export interface Lesson {
  ...
  // Video GUID trong thư viện Bunny Stream (xem sau khi upload video trong Bunny dashboard).
  // Bỏ trống = bài học chưa có video, trang sẽ hiện trạng thái "chưa có video".
  bunnyVideoId?: string;
}
